<?php namespace Sroutier\MenuBuilder\Handlers;
/**
...
use Sroutier\MenuBuilder\Contracts\MenuHandlerInterface;
use Sroutier\MenuBuilder\Traits\MenuHandlerTrait;
...
class BootstrapDarkFixedMenuHandler implements MenuHandlerInterface
{
    ...
    public $MENU_PARTIAL_VIEW   = 'menu-builder::_bootstrap-dark-fixed-menu';
    ...
    public $TRAIL_PARTIAL_VIEW           = 'menu-builder::_bootstrap-light-trail';
